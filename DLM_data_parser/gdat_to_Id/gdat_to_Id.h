// gdat_to_Id.h
//  Header file to gdat_to_Id.c. This contains all of the structs that
//  go into the Id file, hopefully pretty well commented. Unknown parts
//  of the definitions are filled in with U8 arrays. GopherCAN must be
//  included in this project

#include <stdint.h>
// #include "GopherCAN_ids.h" // TODO implement including GCan for names
//  and sizes when dynamic sizing is included in .gdat
typedef uint8_t U8;
...
#define CHANNEL_DESC_START_FLOC 0x1500
